# ============================================================================
# 01_模型拟合与样本内比较.R —— deAyala 数学测验数据
# ----------------------------------------------------------------------------
# 数据：de Ayala (2009, p.14) 的 5 道数学测验题基准数据，以响应模式频数表给出，
#       总人数 n = 19601；每位考生回答 5 个二值题目（对/错）。
#       把 5 个题目看作 5 次伯努利试验，X = 答对题数，取值 0..5，m = 5。
#
# 本脚本做什么：
#   1) 读取数据（每人一个得分），给出描述统计与过度离散检验；
