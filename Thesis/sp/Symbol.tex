...
\newcommand{\Bernstein}{\mbox{Bernstein}}
\newcommand{\BetaBino}{\mbox{Beta-Bino}}
\newcommand{\BernBino}{\mbox{Bern-Bino}}
\newcommand{\blat}{\bla^{(t)}}
\newcommand{\blatI}{\bla^{(t+1)}}
\newcommand{\ibV}{\boldsymbol{V}}
\newcommand{\ibbt}[1]{\ibb^{(t)}_{#1}}
\newcommand{\bBt}{\bB^{(t)}}
\newcommand{\hblas}{\hbla^*}
\newcommand{\cL}{{\cal L}}
